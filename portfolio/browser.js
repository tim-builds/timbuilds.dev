...
(() => {
  ...
  A.register('browser','Internet Browser','globe',(body)=>{
    ...
    function home(){
      content.innerHTML='<section class="browser-home"><span class="browser-home-kicker">timBuilds Internet</span><h1>A place for every project.</h1><p>Explore the websites behind the projects. Ready to play? The game’s own page will take you to a new browser tab.</p><div class="browser-bookmarks"></div><p class="browser-home-note">Some external websites prohibit embedded viewing. Open in real browser is always available.</p></section>';
