...
(() => {
  ...
  const top=document.createElement('nav');top.className='platform-topbar';top.setAttribute('aria-label','GNOME desktop panel');top.innerHTML='<button data-platform-applications>Applications</button><button data-platform-menu="places">Places</button><button data-platform-menu="system">System</button><button class="platform-clock" data-app-open="datetime" aria-label="Open Date/Time Properties"></button><button class="environment-year" data-app-open="versions" aria-label="Change operating system" title="Change operating system"><span data-os-year></span><span class="era-chevron" aria-hidden="true">▾</span></button>';document.body.append(top);
