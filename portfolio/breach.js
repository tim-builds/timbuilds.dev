...
(() => {
  ...
  let disconnect=()=>{}, initialFocus=true;
  ...
  function accept(){
    ...
    root.querySelector('#access-accepted').hidden=false;root.querySelector('.access-state').textContent='LAYER VERIFIED';feedback('Recovery checkpoint accepted. Further diagnostics required.');
  ...
  function mount(body, settings={}) {
    ...
    disconnect=settings.onDisconnect||(()=>{}); initialFocus=settings.focus!==false;
