...
(() => {
  ...
  window.TimExplorer=Object.freeze({resolve,route,pathFor,refresh:win=>{const api=navigators.get(win.querySelector(".explorer-navigation"));if(api)api.go(api.state.now,false);}});
})();
