...
console.log(`PASS: eight themes, ${wallpapers.length} allowlisted wallpaper choices, ${provenance.images.length} existing verified archive hashes/dimensions plus 9 platform images and Windows XP pre-paint defaults.`);
