...
(async()=>{
 ...
 if(!window.TimExplorer.registerFolder({id:'private-candystand',label:'Candystand (Private)',parent:'games',entries:entries.map(e=>'lab-'+e.id)}))throw Error('Private game folder registration failed');
