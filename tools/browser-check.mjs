import {checkTrayReadout} from './check-tray-readout.mjs';
...
try{
 ...
 await checkTrayReadout({evaluate,send,click,box,viewport,navigate,origin,until,sleep,screenshot,output,pass});
