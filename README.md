...
Display includes twelve archived Windows 95 Plus! theme pictures, followed by twelve separately labelled original CSS backgrounds. The archived images are self-hosted at their source resolution, with Fit, Fill, Center and Tile placement. All options have live thumbnail/monitor previews and retain browser-local preferences. No remote runtime image requests, font downloads or wallpaper accounts are used.
